<div class="col-lg-4 nopadding nonpadding" >
				<h3 class="latest-home default-theme-border">Popular Stories</h3>
    <div class="clearboth"></div>
				<ul class="trending-stories">
					 <?php
            $cnt = 0;
            $limit = 5;
            $topstories = $this->mobile_model->get_standard_popular($limit);
