...
<head>
	...
	<link rel="stylesheet" href="<?=base_url('assets/popupslider/ninja-slider.css'); ?>">
	<link href="<?=base_url('assets/css/template.css?').date('ymdhis'); ?>" rel="stylesheet">
...
<div class="container-fluid top-section">
  ...
  <div class="container-fluid wrapper">
			<div class="col-lg-9 col-sm-8 zero-left"><a href="<?=site_url(); ?>"><img src="<?=base_url('assets/img'); ?>/logo.png"  width="265" height="49" alt="Evewoman-logo"/></a></div>
			<div class="col-lg-3 col-sm-4">
					<div class="col-lg-2 col-sm-2 social-icon zero-left zero-right">
						<a href="https://www.facebook.com/EveWoman/">
							<img src="<?=base_url('assets/img'); ?>/facebook.png" class="img-responsive"width="300" height="300" alt="facebook logo" />
						</a>
					</div>
					<div class="col-lg-2 col-sm-2 social-icon zero-left zero-right">
						<a href="https://twitter.com/evewomankenya">
							<img src="<?=base_url('assets/img'); ?>/twitter.png" class="img-responsive"width="300" height="300" alt="twitter logo" />
						</a>
					</div>
					<!-- <div class="col-lg-2 col-sm-2 social-icon zero-left zero-right">
						<a href="#">
							<img src="<?=base_url('assets/img'); ?>/whatsapp.png" class="img-responsive"width="300" height="300" alt="whatsapp logo" />
						</a>
					</div> -->
					<div class="col-lg-2 col-sm-2 social-icon zero-left zero-right">
						<a href="https://web.telegram.org/#/im?p=@evewoman">
							<img src="<?=base_url('assets/img'); ?>/telegram.png" class="img-responsive"width="300" height="300" alt="telegram logo" />
						</a>
					</div>
					<div class="col-lg-2 col-sm-2 social-icon zero-left zero-right">
						<a href="https://www.instagram.com/evewomankenya/">
							<img src="<?=base_url('assets/img'); ?>/instagram.png" class="img-responsive"width="300" height="300" alt="Instagram logo" />
						</a>
					</div>
			  </div>
		</div>
				  ...
				  <?php
				  if(is_array($this->amodel->getNav()))
				  	{	
		...
		<div class="col-lg-8 menu">
			<ul>
				...
				<li><a href="<?=site_url('topic/reproductivehealth'); ?>">SEXUAL HEALTH</a></li>
