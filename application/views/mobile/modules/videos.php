	...
	<div class="container-fluid wrapper">
		...
		<div class="col-lg-1 col-md-1  left-sidebar">
			...
			<h5>By<br><?=@$this->Article_model->getAuthorName($mainvideo->createdby); ?></br></br><?=date('D dS M Y',strtotime($mainvideo->publishdate)); ?></h5>
	    </div>
		<div class="col-lg-8 col-md-8">
    		<iframe width="870" height="auto" src="https://www.youtube.com/embed/<?=$mainvideo->videoURL; ?>?version=3&vq=hd720" frameborder="0" allowfullscreen class="img-responsive" autoplay=1 style="height:460px; width:870px; "></iframe>
					...
					foreach($related as $value)
						{
						 	echo'<div class="col-lg-4 col-md-4 zero-left ">
									...
									<h3><a href="#">By Brian Guserwa </a></h3>
							   	</div>';
						}
					?>
			  	...
			  	foreach ($latest as $value)
			  		{
			  			echo'
							<li>
							<h1><a href="'.site_url('category/'.$this->Category_model->getOtherCatId($value->categoryid).'/'.str_replace(" ","",$this->Article_model->getCatName($value->categoryid))).'">'.$this->Article_model->getCatName($value->categoryid).'</a></h1>
		...
		<img src="img/ad5.gif" class="img-responsive" alt=""/>
		</div>
     </div>	
